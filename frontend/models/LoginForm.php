...
class LoginForm extends Model
{
    ...
    public function rules()
    {
        return [
            ...
            [['username', 'phone_number'], AtLeastValidator::className(), 'in' => ['username', 'phone_number']],
        ];
    }
    ...
    {
        if ($this->_user === null) {
            $this->_user = $this->findAndValidateByUsername($this->username, $this->password, $this->type);
        }
        return $this->_user;
    }

    private function findAndValidateByUsername($username, $password, $user_type = null)
    {
        $user = User::findByUsername($username, $user_type);
